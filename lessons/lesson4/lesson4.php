      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-md-10">
          ...
          <form class="" action="" method="post">
            ...
            <input type="radio" name="format" value="kilometers"><span> км/ч</span>
            <br>
            <input type="radio" name="format" value="meters"><span> м/с</span>
            <br>
          ...
          <?php else : ?>
            ...
            <form class="" action="forms.php" method="post">
              ...
              <input type="text" name="distance_m">
              <p>Введите время затраченое на преодоление пути в секундах</p>
              <input type="text" name="time_s"><br><br>
              <input type="submit" value="Submit">
            </form>
